    ...
    <?php
      ...
      if(!$classes) {
        ...
        foreach($classes as $class_id) {
          $node = $n->retrieveObjecti($class_id,$teacher_id) or die("No record");
          $code = $node->getCode();
          ...
          echo '<div class="class"> 
            ...
            <div><strong>Section-level</strong> : <span class="section">'.$section.'</span></div> 
        ...
        <div class="modal-content">
          ...
          <hr>
            <div id="add_class_form">
              ...
              <input class="form-control" name="code" placeholder="module , Eg : php-120">
              ...
              <input class="form-control" name="start" placeholder="Starting hour (Eg. 001/IT/12)">
              <input class="form-control" name="end" placeholder="Ending hour (Eg. 005/IT/12)">
