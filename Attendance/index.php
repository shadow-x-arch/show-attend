    ...
    <table class="table table-bordered table-striped">
        ...
        <tr>
          ...
          <td>
            <form id="signup">
              <div class="form-group">
                <label>Name</label>
                <input class="form-control" placeholder=" Name EG: 18RP00500-NIYONKURU-ERIC" type="text" name="name">
              </div>
              <div class="form-group">
     ...
     <!-- FOOTER -->
      <footer style="background:; height:120%;">
        ...
        <p style="color:black;font-size:xx-large;text-transform:uppercase"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; iprc karongo</p>
      </footer>
